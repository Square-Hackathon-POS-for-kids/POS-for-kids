### To Do List
- [X] finish adding the GS cookies in Library - ashley
- [X] work on the look of the keypad which would be in css/html (we can pair on the functionality) - ashley
- [X] add quantity icon on top left of cookie images
